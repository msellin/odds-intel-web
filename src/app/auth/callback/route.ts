      ...
      <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
        ...
        <tr>
          <td style="background:#ffffff;padding:28px 32px 32px;border-left:1px solid #e2e8f0;border-right:1px solid #e2e8f0;">
            ...
            <p style="margin:0 0 20px;font-size:14px;color:#475569;line-height:1.6;">Your account is active. Here's what's worth a look:</p>
            <table width="100%" cellpadding="0" cellspacing="0">
              <tr>
                <td style="padding:10px 0;border-bottom:1px solid #f1f5f9;">
                  <span style="font-size:14px;color:#0f172a;font-weight:600;">1. Today's live picks</span><br>
                  <span style="font-size:13px;color:#64748b;">Calibrated pre-match picks from the model — free, no paywall.</span>
                </td>
              </tr>
              <tr>
                <td style="padding:10px 0;border-bottom:1px solid #f1f5f9;">
                  <span style="font-size:14px;color:#0f172a;font-weight:600;">2. Verified track record</span><br>
                  <span style="font-size:13px;color:#64748b;">Every settled bet on the public ledger — ROI, CLV, beat-rate. Nothing hidden.</span>
                </td>
              </tr>
              <tr>
                <td style="padding:10px 0;">
                  <span style="font-size:14px;color:#0f172a;font-weight:600;">3. Get picks live on Telegram</span><br>
                  <span style="font-size:13px;color:#64748b;">Free public channel @oddsintelpicks pushes each pick pre-kickoff.</span>
                </td>
              </tr>
            </table>
            <div style="margin-top:24px;text-align:center;">
              <a href="${SITE_URL}/picks" style="display:inline-block;padding:12px 28px;background:#22c55e;color:#ffffff;font-weight:700;font-size:14px;text-decoration:none;border-radius:6px;">See today's picks →</a>
            </div>
          </td>
        </tr>
        <tr>
