...
export const metadata: Metadata = {
  ...
  description:
    "Side-by-side comparisons of OddsIntel against WinnerOdds, InPlayGuru, DeepBetting, Forebet, Oddspedia, SportBot AI, SofaScore, OddsChecker, soccer-rating, soccerbot.ai. Honest pros and cons, feature matrix, verdict for each.",
